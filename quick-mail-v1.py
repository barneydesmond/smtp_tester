...
"""
This is the original form of this script, the simplest SMTP transaction I could
come up with, barely a replacement for banging it out yourself with a telnet
session.
...
# setup the message
mail = 'Test message from Anchor - run started at %s\n' % TIMESTAMP
mail += FROM + '\n'
mail += TO + '\n\n'
mail += '''This is a test message.
...
#mailer.login('clancy', 'bottle6halt$home')
print "Send emails: ",
for i in range(options.howmany):
	mailer.sendmail(FROM, TO, mail)
	print FROM
	print TO
	print mail
	print i+1
